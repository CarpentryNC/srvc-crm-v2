          ...
          <div className="max-w-md w-full bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6">
            ...
            <div className="flex space-x-3 mt-6">
              ...
              <button
                ...
                className="flex-1 bg-gray-200 dark:bg-gray-600 text-gray-900 dark:text-gray-100 py-2 px-4 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-500 transition-colors"
              >
                Try Again
              </button>
            </div>
