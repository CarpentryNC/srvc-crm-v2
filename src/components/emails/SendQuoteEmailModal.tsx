...
export default function SendQuoteEmailModal({
  ...
  useEffect(() => {
    if (quote.customer?.email && recipients.length === 0) {
  ...
  }, [quote.customer, recipients.length])
  ...
  const getPreview = () => {
    return previewQuoteEmail(quote, customMessage.trim() || undefined)
  }
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    type="text"
                    id="subject"
                    placeholder={`Quote ${quote.quote_number} - ${quote.title}`}
                    value={customSubject}
